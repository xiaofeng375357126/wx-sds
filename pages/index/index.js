...
Page({
  ...
  bannerColor: function (e) {
    this.setData({
      bannerBackgroundVal: this.data.imgUrls[e.detail.current].color
    });
    if (this.data.scrollY !== undefined && this.data.scrollY < 100) {
      this.setData({
        bannerBackground: this.data.imgUrls[e.detail.current].color
      });
    }
  },
  /**
  ...
  onPageScroll: function (e) {
    ...
    if (e.scrollTop >= 100) {
      ...
      this.setData({
        'bannerBackground': this.data.bannerBackgroundVal
      })
    }
  },
  /**
  ...
  getIndexConfig: function () {
    ...
    getIndexData().then(res => {
      if(this.data.scrollY===0){
        this.setData({
          bannerBackground: res.data.banner[0].color,
          bannerBackgroundVal:res.data.banner[0].color,
        })
      }
      that.setData({
